...
Version  : 1.3
Release  : 4
URL      : https://github.com/clearlinux/cloud-native-setup/archive/v1.3.tar.gz
Source0  : https://github.com/clearlinux/cloud-native-setup/archive/v1.3.tar.gz
...
%prep
%setup -q -n cloud-native-setup-1.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1554416302
