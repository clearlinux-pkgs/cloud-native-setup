...
Version  : 1.6
Release  : 7
URL      : https://github.com/clearlinux/cloud-native-setup/archive/v1.6.tar.gz
Source0  : https://github.com/clearlinux/cloud-native-setup/archive/v1.6.tar.gz
...
%prep
%setup -q -n cloud-native-setup-1.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563829928
