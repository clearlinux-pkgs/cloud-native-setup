...
Source0  : https://github.com/clearlinux/cloud-native-setup/archive/v1.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0
Requires: cloud-native-setup-data = %{version}-%{release}
Requires: cloud-native-setup-license = %{version}-%{release}
Patch1: 0001-Fix-Makefile-use-tabs.patch
...
%prep
%setup -q -n cloud-native-setup-1
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1544122289
make  %{?_smp_mflags}
