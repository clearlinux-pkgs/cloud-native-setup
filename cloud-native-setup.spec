...
Version  : 1.2
Release  : 3
URL      : https://github.com/clearlinux/cloud-native-setup/archive/v1.2.tar.gz
Source0  : https://github.com/clearlinux/cloud-native-setup/archive/v1.2.tar.gz
...
%prep
%setup -q -n cloud-native-setup-1.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1549679027
make  %{?_smp_mflags}
